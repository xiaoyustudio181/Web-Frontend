<template>
  <div>
    ...
    <div style="padding:15px;">
      ...
      <x-button @click.native="toggleFormat" :disabled="format === 'YYYY-MM-DD HH'" type="primary"> Toggle format </x-button>
      <x-button @click.native="changeFormatAndValue" type="primary"> Format 2019-10-23 10 </x-button>
